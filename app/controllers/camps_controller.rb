#
# Camps controller generated with scaffold
#
class CampsController < ApplicationController
  ...
  private
    ...
    def camp_params
      params.require(:camp).permit(:name, :location, :age_min, :age_max, :start_time, :end_time, :ext_end_time, :ext_start_time, :description, :fee, :week_id, :kid_limit)
    end
end
